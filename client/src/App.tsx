          ...
          <div className="relative w-32 h-32 flex items-center justify-center">
            <div className="absolute inset-0 rounded-full animate-[spin_10s_linear_infinite] flex items-center justify-center">
              <svg viewBox="0 0 100 100" className="w-full h-full p-0">
                ...
                <text className="text-[8px] font-black uppercase fill-black dark:fill-white">
                  <textPath href="#curve" startOffset="0%" textLength="238.76" lengthAdjust="spacing">
                    CLIP • COLLECT • CURATE • COLLAGE • CLAIM • CLIP • COLLECT • CURATE • COLLAGE • CLAIM • 
                  </textPath>
                </text>
              </svg>
            </div>
